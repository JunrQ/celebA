...
class Attention(nn.Module):
    ...
    def __init__(self, block_num, class_num=100):
        ...
        self.pre_pool = nn.AvgPool2d(kernel_size=3, stride=2, padding=1)
...
def get_models(model_type, depth):
  if model_type == 'attention':
    _depth_map = {
      56 : attention56,
      92 : attention92
    }
    return _depth_map[depth]()

  else:
    raise ValueError("%s not supported" % model_type)
